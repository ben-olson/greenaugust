...
<?php
  if ( have_posts() ) : while ( have_posts() ) : the_post();
    ...
    $next_post = get_adjacent_post(false,'',false)->ID;
    $prev_post = get_adjacent_post(false,'',true)->ID;
  ...
  <div class="[ pagination ] [ flex ]">
    ...
    <div class="[ post__prev ] [ post-link ]">
      ...
      <h3 class="[ upper font:light ]">
        <a href="<?php echo get_permalink($prev_post); ?>"><?php echo '&larr; ' . get_the_title($prev_post); ?></a>
      </h3>
    ...
    <div class="[ post__next ] [ post-link ]">
      ...
      <h3 class="[ upper font:light ]">
        <a href="<?php echo get_permalink($next_post); ?>"><?php echo get_the_title($next_post) . ' &rarr; ' ; ?></a>
      </h3>
